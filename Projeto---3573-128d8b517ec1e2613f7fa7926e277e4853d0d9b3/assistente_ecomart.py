...
def criar_lista_ids():
    ...
    file_dados = cliente.files.create(
        file=open("Projeto---3573-128d8b517ec1e2613f7fa7926e277e4853d0d9b3\\dados\\ecomart.txt", "rb"),
        purpose= "assistants"
    )
    lista_ids_arquivos.append(file_dados.id)

    file_politicas = cliente.files.create(
        file=open("Projeto---3573-128d8b517ec1e2613f7fa7926e277e4853d0d9b3/dados/politicas_ecomart.txt", "rb"),
        purpose= "assistants"
    )
    lista_ids_arquivos.append(file_politicas.id)

    file_produtos = cliente.files.create(
        file=open("Projeto---3573-128d8b517ec1e2613f7fa7926e277e4853d0d9b3\dados\produtos_ecomart.txt", "rb"),
        purpose= "assistants"
    )
