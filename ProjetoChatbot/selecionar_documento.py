...
politicas_ecomart = carrega('ProjetoChatbot/dados/politicas_ecomart.txt')
dados_ecomart = carrega('ProjetoChatbot/dados/dados_ecomart.txt')
produtos_ecomart = carrega('ProjetoChatbot/dados/produtos_ecomart.txt')
